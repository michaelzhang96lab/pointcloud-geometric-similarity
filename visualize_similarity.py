...
def create_comparison_visualization():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'curvature_distributions.png'), dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'curvature_comparison_overlay.png'), dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'similarity_summary.png'), dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'results_table.png'), dpi=150, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'curvature_maps.png'), dpi=150, bbox_inches='tight')
