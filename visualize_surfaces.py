...
def visualize_surfaces():
    ...
    # Load data
    cloud_a = load_csv(os.path.join(data_dir, "cloud_A_high_density_texture1.csv"))
    cloud_b = load_csv(os.path.join(data_dir, "cloud_B_low_density_texture1.csv"))
    cloud_c = load_csv(os.path.join(data_dir, "cloud_C_low_density_texture2.csv"))
